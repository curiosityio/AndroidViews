...
import com.curiosityio.andoidviews.widget.EmptyView
import com.curiosityio.andoidviews.widget.LoadingView
...
open class LoadingEmptyLayout : LinearLayout {
    ...
    fun initialize(context: Context, attrs: AttributeSet, defStyleAttr: Int) {
        ...
        try {
            ...
            mLightDarkMode = a.getInt(R.styleable.LoadingEmptyLayout_loadingView_lightDarkMode, LoadingView.LIGHT_MODE)
        } finally {
            a.recycle()
        }
    }
